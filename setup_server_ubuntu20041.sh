...
dpkg -i ./ubuntu20041/basic/archives/*.deb
...
#----------- download nvidia driver / cuda / cudnn installation files
	...
	dpkg -i ./ubuntu20041/gpu/archives/*.deb
...
if [ ${docker_install} = yes ] || [ ${docker_install} = y ] ; then
	...
	dpkg -i ./ubuntu20041/docker/archives/*.deb
...
if [ ${nvidia_docker_install} = yes ] || [ ${nvidia_docker_install} = y ] ; then
	...
	dpkg -i ./ubuntu20041/nvidia-container-toolkit/archives/*.deb
